...
from tests.test_data import INVALID, ETHANE, HEXANE, PROPANE, BUTANE
...
class TestDataset(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.data_set_invalid = Dataset([INVALID], self.model_voc)
    ...
    def test_len_invalid(self):
        self.assertEqual(len(self.data_set_invalid), 0)
