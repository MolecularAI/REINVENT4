...
from tests.test_data import WARHEAD_PAIR, WARHEAD_TRIPLE, WARHEAD_QUADRUPLE, SCAFFOLD_TO_DECORATE, LINKER_TRIPLE
...
def mocked_linkinvent_model():
    ...
    model = LinkinventModel(vocabulary, encoder_decoder)
    _init_params(model.network.parameters())
    return model

def mocked_vocabulary():
    smiles_list = [WARHEAD_PAIR, WARHEAD_TRIPLE, WARHEAD_QUADRUPLE, SCAFFOLD_TO_DECORATE, LINKER_TRIPLE]
