...
from reinvent.chemistry.library_design import AttachmentPoints, BondMaker
...
class TestAttachmentPoints(unittest.TestCase):
    ...
    def test_add_first_attachment_point_number(self):
        result = self._attachment_points.add_first_attachment_point_number(
            SLICED_ANILINE_DERIVATIVE, 0
        )
