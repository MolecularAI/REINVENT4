...
def test_metadata_passing(use_pumas):
    ...
    scorer_config_geo_mean = {
        ...
        "component": [
            {
                "custom_alerts": {
                    "endpoint": [{"name": "Unwanted F", "weight": 1, "params": {"smarts": ["F"]}}]
                }
            },
            {
                "custom_alerts": {
                    "endpoint": [{"name": "Unwanted S", "weight": 1, "params": {"smarts": ["S"]}}]
                }
            },
            {
                "custom_alerts": {
                    "endpoint": [{"name": "Unwanted CO", "weight": 1, "params": {"smarts": ["CO"]}}]
                }
            },
        ],
    }
    ...
    metadata_res_names = [
        "matchting_patterns (Unwanted F)",
        "matchting_patterns (Unwanted S)",
