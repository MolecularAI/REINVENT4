...
* LillyDescripts: 259 descriptors from Ely Lilly.  The parameters are a list of wanted descriptors used and the top directory of the LillyMol installation.  Unfortunately, there is little documentation available.  Descriptor groups:
